      ...
      <ul className="mx-auto mt-14 grid max-w-md gap-3 text-left">
        {doors.map(({ href, label, sub, Icon }) => (
          <li key={href}>
            <Link
              href={href}
              className="journey-step group flex items-center justify-between gap-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tomato/30 focus-visible:ring-offset-2 active:scale-[0.99] motion-reduce:active:scale-100"
            >
