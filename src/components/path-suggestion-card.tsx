...
export function PathSuggestionCard({ career, onBuildPath, building }: PathSuggestionCardProps) {
  return (
    <article className="card-lift flex flex-col rounded-2xl border border-ink/10 bg-cream p-5 hover:border-tomato/25 hover:shadow-lift focus-within:border-tomato/30 focus-within:ring-2 focus-within:ring-tomato/20">
