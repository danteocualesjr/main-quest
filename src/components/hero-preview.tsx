...
export function HeroPreview() {
  return (
    <div className="relative">
      ...
      <div className="corner-ticks relative rounded-2xl border border-ink/12 bg-cream p-7 text-ink/20 shadow-lift transition duration-300 hover:shadow-soft md:p-8">
