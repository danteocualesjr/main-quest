  ...
  if (!open) {
    return (
      <button
        ...
        className="coach-launcher group mt-12 flex w-full items-start gap-5 focus-visible:ring-2 focus-visible:ring-tomato/35 focus-visible:ring-offset-2 focus-visible:ring-offset-paper active:scale-[0.995] motion-reduce:active:scale-100"
        aria-expanded={false}
